# ╔══════════════════════════════════════════════════════════════════════╗
# ║  PLACEHOLDER — replace on the AMD machine before building this host.   ║
# ╚══════════════════════════════════════════════════════════════════════╝
#
# This must come from THIS machine — it pins root/boot filesystems, swap,
# disk/initrd kernel modules, and CPU microcode. On the target AMD machine:
#
#   cp /etc/nixos/hardware-configuration.nix \
#      ~/path/to/nixos-config/hosts/nixos/amd/hardware-configuration.nix
#   # or: sudo nixos-generate-config --show-hardware-config \
#   #        > hosts/nixos/amd/hardware-configuration.nix
#
# Then `git add` it and: nixos-rebuild switch --flake .#amd
#
