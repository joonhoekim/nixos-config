...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "joonhoekim"
    user-mail-address "26rote@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jh/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jh/bin" "/profile/bin" "/Users/jh/.npm-packages/bin" "/Users/jh/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
