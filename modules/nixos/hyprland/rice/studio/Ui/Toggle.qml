...
//
// 창 안에서 자기가 값을 들고 도는 스위치(설명 보기)도 이것을 쓴다. 그쪽은 부른
// 자리에서 `checked` 를 직접 뒤집는다.
...
Item {
    ...
    // 배경(surfaceCard)과 거의 안 갈리고, 화면 셰이더까지 걸린 상태에서는
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            color: root.checked ? Theme.primaryText : Theme.fade(Theme.surfaceText, 0.55)
